...
3. ~~**An EU region is not sovereignty: what data residency really buys you**~~ · **PUBLISHED 2026-09-09** → `src/content/work/2026-09-eu-region-not-sovereignty.mdx` · residency (EU Data Boundary, Fabric multi-geo, BigQuery EU multi-region) vs sovereignty (CLOUD Act reach, legal entity structure), the EU-US Data Privacy Framework's shaky footing, what a sovereign-tier provider costs, and an honest disqualifier for most SMEs · M
...
31. ~~**Power BI Pro or a Fabric capacity? The F64 licensing cliff, in euros**~~ · **SUPERSEDED, not written standalone (2026-09-09):** when post 7 shipped on 2026-08-26 it already carried the full F64 break-even math this idea proposed — the exact "below F64 every viewer still needs a Pro licence" trap, the EUR gap (~€5,125/month at reserved F64 vs F2), and the ~390-seat break-even, plus its own `PowerBiLicensingCliff` diagram (see the post's "Does a Fabric capacity replace Power BI Pro licences?" section). A second standalone post repeating that same finding would be near-total duplication, not a companion piece, so this run skipped it and took queue item 3 instead. Original SERP note kept for the record: "power bi pro vs fabric capacity licensing" / "fabric f64 vs power bi pro break even" · en · **17** (5/4/4/4) · resellers and licensing agencies (Solv Systems, EPC Group, SpendWeave, datatako) plus several UK consultancies, every one of them quoting USD and one explicitly scoping its break-even to "standard US Azure regions".
...
### Follow-up surfaced while writing post 13 (2026-08-31)
...
- A: ~~7~~ (published 2026-08-26), ~~31~~ (superseded, see idea bank), ~~3~~ (published 2026-09-09), 8, 2, **32**, **33**, 21, 22, 23, **34**, 25, **36**, 24, 5, 10, 12
...
3. ~~**Post 3: An EU region is not sovereignty (pillar 1).**~~ **Shipped 2026-09-09.** The best buyer-intent pocket in the sovereignty noise; it sets up the residency column in the Fabric vs BigQuery comparison two slots later, covers the EU-US Data Privacy Framework's current legal uncertainty, and prices the sovereign-cloud premium (roughly 10 to 15 percent, AWS European Sovereign Cloud).
4. ~~**Post 13: RAG and sheet music (pillar 3).**~~ **Shipped 2026-08-31.** The series that worked gets its second entry while the surf post is still fresh; it passes all four tests in 1.3 and doubles as the plain-language RAG explainer pillar 4 can link to.
